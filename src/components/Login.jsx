        ...
        <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
          <div className="max-w-7xl mx-auto w-full">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              {/* Sección Izquierda - Contenido atractivo */}
              <div className="text-center lg:text-left space-y-8">
                {/* Badge animado */}
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-orange-100 to-amber-100 rounded-full border border-orange-200 shadow-lg">
                  <div className="w-2 h-2 bg-orange-500 rounded-full animate-pulse" />
                  <span className="text-orange-700 font-semibold text-sm">🌟 Bienvenidos a AgroMAE</span>
                </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-center lg:justify-start gap-3">
                    ...
                    <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-orange-600 via-amber-600 to-yellow-600 bg-clip-text text-transparent leading-tight">
                      Sabor artesanal
                    </h1>
                    <Sparkles className="w-8 h-8 text-amber-500 animate-pulse delay-300" />
                  </div>
                  <p className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-gray-700 leading-tight">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <button
                    ...
                    className="group relative px-8 py-4 bg-gradient-to-r from-orange-600 to-amber-500 text-white rounded-2xl font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 overflow-hidden"
                  >
                  ...
                  <Link
                    to="/catalogo-publico"
                    className="group relative px-8 py-4 bg-white/90 backdrop-blur text-orange-700 rounded-2xl font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border-2 border-orange-200 overflow-hidden"
                  >
                ...
                <div className="space-y-4 max-w-2xl mx-auto lg:mx-0">
                  ...
                  <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
                    <span className="inline-flex items-center px-4 py-2 rounded-full bg-orange-100 text-orange-700 font-medium shadow-md">
                      🥩 Productos Frescos
                    </span>
                    <span className="inline-flex items-center px-4 py-2 rounded-full bg-amber-100 text-amber-700 font-medium shadow-md">
                      🏺 Artesanal
                    </span>
                    <span className="inline-flex items-center px-4 py-2 rounded-full bg-green-100 text-green-700 font-medium shadow-md">
                      � Natural
                    </span>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto lg:mx-0">
                ...
                {/* Sección Derecha - Formulario de Login (solo si está expandido) */}
                {loginExpandido && (
